...
/**
 * 共用同一个createBean方法（AbstractAutowireCapableBeanFactory#createBean），只是prototype的bean不会被放置到缓存中
 */
public class SpringClient8_prototype的bean {

    public static void main(String[] args) {
        //1.定义一个资源
        Resource resource = new ClassPathResource("applicationContext6.xml");
