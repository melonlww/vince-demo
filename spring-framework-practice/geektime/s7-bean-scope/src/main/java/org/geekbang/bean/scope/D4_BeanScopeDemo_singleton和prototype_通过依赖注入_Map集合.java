 ...
 *
 */
public class D4_BeanScopeDemo_singleton和prototype_通过依赖注入_Map集合 {
    ...
    public static void main(String[] args) {
        ...
        applicationContext.register(D4_BeanScopeDemo_singleton和prototype_通过依赖注入_Map集合.class);
        // 启动 Spring 应用上下文
    ...
    private static void scopedBeansByInjection(AnnotationConfigApplicationContext applicationContext) {
        D4_BeanScopeDemo_singleton和prototype_通过依赖注入_Map集合 beanScopeDemo = applicationContext.getBean(D4_BeanScopeDemo_singleton和prototype_通过依赖注入_Map集合.class);
