 ...
 *
 */
public class D9_NoUniqueBeanDefinitionExceptionDem_NoUniqueBeanDefinitionException异常 {

    public static void main(String[] args) {
        // 创建 BeanFactory 容器
        AnnotationConfigApplicationContext applicationContext = new AnnotationConfigApplicationContext();
        // 将当前类 NoUniqueBeanDefinitionExceptionDemo 作为配置类（Configuration Class）
        applicationContext.register(D9_NoUniqueBeanDefinitionExceptionDem_NoUniqueBeanDefinitionException异常.class);
        // 启动应用上下文
